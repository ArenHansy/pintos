...
struct thread *get_max_waiting_queue (struct semaphore *sema);
void update_max_priority (struct semaphore *sema);
struct thread *pop_waiting_queue (struct semaphore *sema);
